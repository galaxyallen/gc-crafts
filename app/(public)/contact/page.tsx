...
export default async function ContactPage() {
  const [settingsRows, pageContact] = await Promise.all([
    prisma.setting.findMany(),
    prisma.pageContent.findUnique({ where: { section: "page_contact" } }),
  ]);
  ...
  return (
    <>
      <PageHero
        ...
        description="Whether you're looking for standard products or a fully custom OEM solution, we'd love to hear from you."
