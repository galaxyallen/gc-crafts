...
import { buildCollectionCards, getFactoryStats } from "@/lib/content";
...
async function getHomeData() {
  ...
  return {
    ...
    productCards: buildCollectionCards(contentMap.collection_cards, products),
...
export default async function HomePage() {
  ...
  return (
    ...
    <>
      ...
      <ProductGrid cards={data.productCards} />
