...
import { getContentMap, getFactoryStats } from "@/lib/content";
...
export default async function OemPage() {
  ...
  const [contentMap, factoryStats] = await Promise.all([

    getContentMap(["oem_intro", "oem_capabilities", "oem_process", "factory_gallery"]),
          ...
          <div className="factory-grid">
            ...
            {gallery.images.map((img, i) => (
              ...
              <div key={img.url} className={`factory-img rv${i > 0 ? ` d${Math.min(i, 4)}` : ""}`}>
                ...
                <Image src={img.url} alt={img.alt} width={800} height={500} loading="lazy" unoptimized={isUnoptimizedImage(img.url)} />
